...
export const metadata: Metadata = {
  title: 'Invest in Skramble | West Side Location 4',
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 pt-20 pb-16">
        <p className="text-emerald-400 uppercase tracking-widest text-xs font-semibold mb-4">
      ...
      <section className="px-6 pb-16">
        <div className="max-w-4xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            { value: '52', label: 'Presales Sold Before Launch' },
      ...
      <section className="px-6 pb-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-zinc-400 text-center text-sm mb-8">
            Three thriving locations. One more on the way.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
              <Image
                src="/investors/floorplan.jpg"
                alt="West Side floor plan — 8,289 sq ft"
                fill
                className="object-cover"
              />
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent px-4 py-3">
                <p className="text-white text-xs font-medium">West Side Floor Plan — 8,289 sq ft</p>
              </div>
            </div>
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
              <Image
                src="/investors/facility.jpg"
                alt="Skramblehouse facility interior"
                fill
                className="object-cover"
              />
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent px-4 py-3">
                <p className="text-white text-xs font-medium">Simulator Bays + Putting Green</p>
              </div>
            </div>
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
              <Image
                src="/investors/vibe.jpg"
                alt="Skramblehouse community event"
                fill
                className="object-cover"
              />
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/80 to-transparent px-4 py-3">
                <p className="text-white text-xs font-medium">The Skramble Vibe</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto bg-zinc-900 rounded-3xl border border-zinc-800 p-8 sm:p-12">
          ...
          <div className="space-y-4 text-zinc-300 leading-relaxed">
            <p>
              ...
              our largest and most ambitious location yet. This is a <span className="text-white font-semibold">fixed-return private loan</span> at{' '}
              <span className="text-emerald-400 font-semibold">12% annually</span>, structured to keep things simple and investor-friendly.
            </p>
            <p>
              You&apos;re not buying equity — you&apos;re lending to a proven operation with real revenue,
              real members, and 18 months of free rent already locked in at the West Side space.
            </p>
            <p>
              The loan can be paid off early with zero penalties. Payments start July 1, 2026.
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-zinc-800/60 rounded-2xl p-5 border border-zinc-700">
              <p className="text-emerald-400 font-semibold text-sm uppercase tracking-wide mb-2">Jul – Dec 2026</p>
            ...
            <div className="bg-zinc-800/60 rounded-2xl p-5 border border-zinc-700">
              <p className="text-emerald-400 font-semibold text-sm uppercase tracking-wide mb-2">Jan 2027 – Jun 2031</p>
              <p className="text-white font-bold text-lg mb-1">Principal + Interest</p>
              <p className="text-zinc-400 text-sm">54 monthly payments. No prepayment penalty — we can pay you out early.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 pb-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-zinc-400 text-center text-sm mb-8">Four levels. All at 12% annual return.</p>
            ...
            {TIERS.map((tier, i) => (
              ...
              >
                ...
                <div className="border-t border-zinc-700/50 pt-3 space-y-2">
                  <div>
                    <p className="text-zinc-500 text-xs uppercase tracking-wide">First 6 months</p>
                    <p className="text-white font-semibold">{tier.interestOnly}</p>
                  </div>
                  <div>
                    <p className="text-zinc-500 text-xs uppercase tracking-wide">Months 7 – 60</p>
                    <p className="text-white font-semibold">{tier.payment}</p>
                  </div>
                  <div>
                    <p className="text-zinc-500 text-xs uppercase tracking-wide">Total interest earned</p>
      ...
      <section className="px-6 pb-16">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-zinc-400 leading-relaxed">
            ...
            We&apos;ve built a brand that people love — members, events, leagues, and a community
            that keeps coming back. West Side is our biggest footprint yet, and we&apos;ve already
            sold <span className="text-white font-semibold">52 of 100 presale memberships</span> before
            opening a single door. The momentum is real.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-24">
        <div className="max-w-xl mx-auto bg-zinc-900 border border-zinc-800 rounded-3xl p-8 sm:p-10 text-center">
          <h2 className="text-2xl font-bold mb-3">Ready to Talk?</h2>
          <p className="text-zinc-400 mb-6 leading-relaxed">
            Reach out directly and we&apos;ll walk you through everything. Spots are limited.
          </p>
          <a
            href="mailto:Theskamblehouseofgolfroc@gmail.com?subject=Skramble West Side — Investor Inquiry"
            className="inline-block bg-emerald-500 hover:bg-emerald-400 text-black font-bold px-8 py-4 rounded-full text-sm uppercase tracking-wide transition-colors"
          >
            Get in Touch
          </a>
          <p className="text-zinc-600 text-xs mt-4">
            Theskamblehouseofgolfroc@gmail.com · (585) 690-3494
          </p>
        </div>
      </section>

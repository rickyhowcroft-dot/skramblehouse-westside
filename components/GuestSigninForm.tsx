    ...
    <main style={{ backgroundColor: '#fff', color: GRAY_1, fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 20px 0', textAlign: 'center' }}>
        <div style={{
          ...
          <span style={{ color: BLUE, fontWeight: 700, fontSize: 12, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            {location}
          </span>
        </div>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 20px 80px' }}>
        <div style={{
          backgroundColor: '#fff', border: `1px solid ${GRAY_4}`,
...
function SectionDivider({ label, color }: { label: string; color: string }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
      ...
      <span style={{ fontSize: 14, fontWeight: 800, color, letterSpacing: '0.06em', textTransform: 'uppercase' }}>
        {label}
      </span>
